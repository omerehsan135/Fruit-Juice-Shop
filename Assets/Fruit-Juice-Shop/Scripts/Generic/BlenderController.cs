...
public class BlenderController : MonoBehaviour {
	...
	void Update() {
		...
		//make the blender material looks like normal when player is not pressing a finger
	...
	void manageDeliveryDrag (){
		...
		if(Physics.Raycast(ray, out hitInfo)) {
			...
			if(objectHit.name == "BlenderStartButton" && objectHit.transform.parent.gameObject == gameObject && !IngredientsController.itemIsInHand) {
